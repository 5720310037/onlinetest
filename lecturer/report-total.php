  ...
  <div class="content-wrapper">
        ...
        <div class="col-lg-8">
          <div class="card mb-3">
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                if($manage == 1) {
                  ...
                  $q = "SELECT gr_id AS group_id, lec_group
                        FROM lec_group l
                        WHERE sub_id = '$sub_id' AND term = '$term' AND year = '$year' AND lec_id = '$lec_id'";
                }
                $r = mysqli_query($link, $q); 
                ...
                while ($row = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
                  ...
                  echo '<tr align="center">
                          <td>'.$row['lec_group'].'</td>
                          <td>'.$count.'</td>
                          <td><a href="report.php?group_id='.$group_id.'">View</a>
                          </td>
                      </tr>';
                      $order++;
                }
            ...
            <div class="card-footer small text-muted"> 
              <a href="report-list.php" class="previous">&laquo; Previous</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <?php
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <b>Sorry, you can not access Quizzes!</b>
          </li>
        </ol>
      </div> ';
      mysqli_close($link);
